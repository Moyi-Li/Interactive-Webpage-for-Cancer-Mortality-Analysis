          ...
          tabsetPanel(
            tabPanel("General information",
              p("This data is from dataplanet and focuses on the number of people who have developed cancer in", strong("four"), 
                "parts of the human body from 2009 to 2018 by female and male in middle geological part of the United State. 
  ...
  output$popdata <- renderText({
    cancertable <- cancerI %>%
      ...
      paste("The max population from these years are brest cancer, which is ", .,
            ...
            which is a very large number among the whole population in middle geological part of the United States.")
  })
